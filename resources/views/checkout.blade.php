                                ...
                                <div class="cheque">
                                    ...
                                    <div class="logos">
                                        <a href="#" class="logos-item">
                                            <img src="{{ asset('uploads/products/visa.png') }}" alt="Visa">
                                        </a>
                                        <a href="#" class="logos-item">
                                            <img src="{{ asset('uploads/products/mastercard.png') }}" alt="MasterCard">
                                        </a>
                                        <a href="#" class="logos-item">
                                            <img src="{{ asset('uploads/products/discover.png') }}" alt="DISCOVER">
                                        </a>
                                        <a href="#" class="logos-item">
                                            <img src="{{ asset('uploads/products/amex.png') }}" alt="Amex">
                                        </a>
                             	...
                             	<form action="{{ route('cart.checkout') }}" method="POST">
                                  ...
                                  <script
                                          ...
                                          data-key="pk_test_G0JMmfxjzv5QfEfwsiK68rNH"
